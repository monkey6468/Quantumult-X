...
let MT_PROVINCE = $.getdata('MT_PROVINCE') || '湖南省';
let MT_CITY = $.getdata('MT_CITY') || '长沙市';
let MT_DISTRICT = $.getdata('MT_DISTRICT') || '雨花区｜芙蓉区｜天心区';
let MT_ITEM_BLACK = $.getdata('MT_ITEM_BLACK') || '10056'; // "10213": "53%vol 500ml贵州茅台酒（癸卯兔年）", "10214": "53%vol 375ml×2贵州茅台酒（癸卯兔年）", "10056": "53%vol 500ml茅台1935", "2478": "53%vol 500ml贵州茅台酒（珍品）"
