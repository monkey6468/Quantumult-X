...
[Script]
茅台Token = type=http-request,pattern=^https:\/\/app\.moutai519\.com\.cn\/xhr\/front\/mall\/message\/unRead\/query,requires-body=0,max-size=0,script-path=https://github.com/Jun-gle/Quantumult/raw/main/i-maotai.js

i 茅台 = type=cron,cronexp=17 9 * * *,timeout=60,script-path=https://github.com/Jun-gle/Quantumult/raw/main/i-maotai.js,script-update-interval=0
...
[Script]
http-request ^https:\/\/app\.moutai519\.com\.cn\/xhr\/front\/mall\/message\/unRead\/query tag=茅台Token, script-path=https://github.com/Jun-gle/Quantumult/raw/main/i-maotai.js,requires-body=0

cron "17 9 * * *" script-path=https://github.com/Jun-gle/Quantumult/raw/main/i-maotai.js,tag = i 茅台,enable=true
